...
const Contact = () => {
    return (
        <div name='contact' className='w-full h-screen bg-[#ecf0f3] flex justify-center items-center p-4'>
            <form action="https://getform.io/f/575119dc-95c0-4def-932b-7fc398c7ea52" method='POST' className='flex flex-col max-w-[600px] w-full'>
                ...
                <button className='text-gray-700 group border-2 border-[#423ebe]  hover:text-white hover:bg-[#423ebe] hover:border-[#423ebe] px-4 py-3 my-8 mx-auto flex items-center'>Send Message</button>
            </form>
        </div>
    );
};
